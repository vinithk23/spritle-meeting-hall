!function () {
    ...
    var e = {
        572: function (e, t, n) {
            n.r(t), t.default = '<div class="">\r\n\r\n    <div class="dpw-header">\r\n        <div class="dpw-header-inner">\r\n            <div class="dpw-header-item dpw-header-main" style="display: flex; justify-content: center;"><a href="https://spritle.com/">Spritle - Meeting hall booking</a></div>\r\n            <div class="dpw-header-right">\r\n            </div>\r\n        </div>\r\n    </div>\r\n\r\n    <div class="dpw-subheader">\r\n        <div class="dpw-subheader-inner toolbar">\r\n        </div>\r\n    </div>\r\n\r\n    <div class="dpw-title">\r\n        <div class="dpw-title-inner" style="display: none;">\r\n            <div class="download" style="display: flex;">\r\n                <div style="margin-right: 10px;"><a href="https://javascript.daypilot.org/files/daypilot-pro-javascript-trial-2023.2.5582.zip" class="inline-btn track-download"><span>Download</span></a></div>\r\n                <div style="flex-grow: 1;">\r\n                    <div>Download a trial version (1.1 MB).</div>\r\n                    <div><a href="https://javascript.daypilot.org/files/daypilot-pro-javascript-trial-2023.2.5582.zip" class="track-download">daypilot-pro-javascript-trial-2023.2.5582.zip</a></div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n\r\n    <div class="dpw-main">\r\n        <div class="dpw-sidebar menu">\r\n            <div class="search">\r\n                <div class="search-box"><input type="text" id="search-box-input" placeholder="Quick search"><button id="search-box-clear">&times;</button></div>\r\n            </div>\r\n\r\n        </div>\r\n        <div class="dpw-body" style="padding: 15px;">\r\n            <div class="dpw-body-inner">\r\n                <div class="placeholder"></div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class="dpw-footer">\r\n        <div class="dpw-footer-inner">\r\n        </div>\r\n    </div>\r\n\r\n</div>\r\n'
        }, 752: function (e, t, n) {
            (new (n(447).t)).init()
        }, 722: function (e, t) {
            ...
            var i = n(572), l = n(4), a = n(143), r = n(11), m = n(463), o = n(730), s = n(151), h = n(722),
                c = function () {
                    function e() {
                        this.content = a.o.get("content"), this.location = new r.p(window.location.protocol, window.location.host, this.content.dataset.path || window.location.pathname), this.search = new m.S, this.C = new l.T, this.A = new o.v, this.version = ""
                    }
                    ...
                    return e.prototype.init = function () {
                        ...
                        if (e.innerHTML = i.default, this.location.j) document.body.className = "dpw-no-sidebar"; else {
                            var t = a.o.h(e, "menu"), n = this.k();
                            t.appendChild(n), document.body.className = "dpw-sidebar-left"
                        }
                        var l = a.o.h(e, "toolbar"), r = this.R();
                        l.appendChild(r);
                        var m = a.o.h(e, "placeholder");
                        this.placeholder = m, h.l.m ? m.appendChild(this.content) : m.appendChild(this.content.content), new s.P(this.placeholder).D(), document.body.insertBefore(e, document.body.firstChild), this.search.g(), this.location.G && !this.location.sandbox && this.A.g()
                    }, e.prototype.k = function () {
                        var e = this, t = a.o.create("div");
                        t.className = "dp-menu";
                        var n = a.o.create("ul"), i = this.location.O;
                        return this.C.getItems(i).forEach((function (t) {
                            var i = t.filename;
                        ...
                        var e = this, t = a.o.u(), n = this.location.j ? "" : "../",
                            i = this.location.filesystem ? "index.html" : "",
                            l = this.location.sandbox ? "Sandbox" : "Demo", r = this.J(l, n + i, this.location.j);
                        return t.appendChild(r.div), this.C.L().forEach((function (l) {
                            var a = "" + n + l.O + "/" + i, r = l.O === e.location.O, m = e.J(l.text, a, r);
                            t.appendChild(m.div)
                        })), t
            ...
            var n = function () {
                ...
                return Object.defineProperty(e.prototype, "j", {
                    ...
                    var t = e.lastIndexOf("/"), n = e.lastIndexOf("/", t - 1), i = e.substring(n + 1, t);
            ...
            var i = n(143), l = function () {
                function e() {
                    this.U = null
                }

                return e.prototype.g = function () {
                    var e = this, t = this.Y = i.o.get("search-box-input");
                    t.addEventListener("keyup", (function (n) {
                        "Escape" !== n.key && "Esc" !== n.key || (t.value = ""), e.Z(t.value)
                    ...
                    t ? this.ee() : this.te(), i.o.query(".menu li").forEach((function (n) {
                        var i = n.getElementsByTagName("a")[0],
                            l = i && -1 !== i.innerText.toLowerCase().indexOf(e.toLowerCase()), a = t || l;
            ...
            Object.defineProperty(t, "i", {value: !0}), t.P = void 0;
            var i = n(143), l = n(827), a = n(722), r = function () {
                function e(e) {
                    this.placeholder = e
                }
            ...
            var n = [{
                ...
                children: [{text: "Main"}, {
                ...
                }, {text: "Events"}, {text: "All-Day Events", filename: "allday.html"}, {
                    text: "Active Areas",
                ...
                }, {text: "Column Moving", filename: "columnmoving.html", H: !0}, {
                    ...
                    H: !0
                }, {text: "Grid"}, {text: "50 columns", filename: "50columns.html"}, {
                    text: "100% height",
                    filename: "100pctheight.html"
                }, {text: "Crosshair", filename: "crosshair.html"}, {
                    text: "Disabled Cells",
                    filename: "cellsdisabled.html"
                }, {text: "Time Range Selecting", filename: "timerangeselecting.html"}, {
                    text: "Zoom",
                    filename: "zoom.html",
                    H: !0
                    ...
                    text: "RTL",
                    filename: "rtl.html"
                }, {text: "Timeline"}, {text: "Overnight Shift", filename: "overnight.html"}, {
                    text: "Lunch Break",
                    filename: "lunchbreak.html"
                }, {
                    text: "Time Header Cell Duration",
                    filename: "timeheadercellduration.html"
                }, {text: "Export"}, {text: "JPEG Export", filename: "exportjpeg.html"}, {
                    text: "SVG Export",
                    filename: "exportsvg.html"
                }, {text: "API"}, {text: "Angular", filename: "angular2.html"}, {
                    text: "AngularJS",
                    filename: "angularjs.html"
                }, {text: "AngularJS (Controller As)", filename: "angularjsctrlas.html"}, {
                    text: "jQuery",
                    filename: "jquery.html"
                }, {text: "View Types"}, {text: "Day View", filename: "day.html"}, {
                    text: "Week View",
                    filename: "week.html"
                ...
                children: [{text: "Main"}, {
                ...
                }, {text: "Event Start and End Time", filename: "eventstartend.html"}, {
                    text: "Event End Spec",
                    ...
                    filename: "cellsdisabled.html",
                    H: !0
                }, {text: "Highlighting Today", filename: "today.html"}, {text: "Export"}, {
                    text: "JPEG Export",
                    filename: "exportjpeg.html"
                }, {text: "SVG Export", filename: "exportsvg.html"}, {text: "API"}, {
                    text: "Angular",
                ...
                children: [{text: "Main"}, {
                    ...
                    text: "Traditional Theme",
                    filename: "themetraditional.html"
                }, {text: "Blue Theme", filename: "themeblue.html"}, {text: "Controls"}, {
                    text: "Message Bar",
                ...
                }, {text: "Highlighting Weekends", filename: "highlighting.html"}, {
                    ...
                    filename: "hide.html"
                }, {text: "Hiding Non-Business Hours", filename: "hidingnonbusiness.html"}, {
                    text: "Separators",
                ...
                }, {text: "Export"}, {text: "SVG Export", filename: "exportsvg.html"}, {
                    text: "PNG Export",
                    filename: "exportpng.html"
                }, {text: "JPEG Export", filename: "exportjpg.html"}, {
                    text: "Printing",
                    filename: "exportprint.html"
                }, {text: "Gantt"}, {text: "Gantt", filename: "gantt.html"}, {text: "API"}, {
                    text: "Angular",
                    filename: "angular2.html"
                }, {text: "AngularJS", filename: "angularjs.html"}, {
                    text: "AngularJS (Controller As)",
                    filename: "angularjsctrlas.html"
                }, {text: "jQuery", filename: "jquery.html"}, {text: "Vue.js", filename: "vuejs.html"}, {
                    text: "React",
                    filename: "react.html"
                }, {text: "View Types"}, {
                    text: "Timesheet",
                ...
                }, {text: "Group Concurrent Events", filename: "groupconcurrent.html"}, {
                ...
                }, {text: "Event Customization", filename: "eventcustomization.html"}, {
                    text: "Event Deleting",
                    filename: "eventdeleting.html"
                }, {text: "Event Filtering", filename: "eventfiltering.html"}, {
                    text: "Event Height",
                ...
                }, {text: "Event Multi-Moving", filename: "eventmultimoving.html"}, {
                    text: "Event Multi-Resizing",
                    filename: "eventmultiresizing.html"
                }, {text: "Event Multi-Selecting", filename: "eventmultiselecting.html"}, {
                    ...
                    text: "Resource Tree",
                    filename: "tree.html"
                }, {text: "Resource Utilization", filename: "resourceutilization.html"}, {
                    text: "Row Creating",
                ...
                }, {text: "Row Header Columns", filename: "rowheadercolumns.html"}, {
                    text: "Row Header Hiding",
                    filename: "rowheaderhiding.html"
                }, {text: "Row Header Scrolling", filename: "rowheaderscrolling.html"}, {
                    text: "Row Moving",
                ...
                children: [{text: "Main"}, {
                    ...
                    filename: "index.html"
                }, {text: "Rows"}, {text: "Row Editing", filename: "rowediting.html", H: !0}, {
                    text: "Row Filtering",
                    filename: "rowfiltering.html",
                    H: !0
                }, {text: "Row Selecting", filename: "rowselecting.html"}, {text: "Tasks"}, {
                    text: "Task Bubble",
                ...
                }, {text: "Export"}, {text: "PNG Export", filename: "exportpng.html"}, {
                    text: "SVG Export",
                    filename: "exportsvg.html"
                }, {text: "Links"}, {text: "Links", filename: "links.html"}, {text: "Grid"}, {
                    text: "Auto Cell Width",
                    filename: "autocellwidth.html"
                }, {text: "API"}, {text: "Angular", filename: "angular2.html"}, {
                    text: "AngularJS",
                ...
                }, {text: "External Drag and Drop", filename: "external.html"}, {text: "Swimlanes"}, {
                    text: "Swimlanes",
    ...
    n.r = function (e) {
        "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(e, Symbol.toStringTag, {value: "Module"}), Object.defineProperty(e, "i", {value: !0})
    }, n(752)
}();